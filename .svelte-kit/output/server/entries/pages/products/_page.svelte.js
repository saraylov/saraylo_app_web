...
function ProductCard($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    let isHovered = false;
    $$renderer2.push(`<article class="product-card svelte-11ja2cl"><div class="card-header svelte-11ja2cl"><div class="product-icon svelte-11ja2cl">${escape_html(
      // Обработчик клика удален - навигация осуществляется через ссылку
      product.icon
    )}</div> <span${attr_class("product-type svelte-11ja2cl", void 0, {
